...
public class AreaEmprestimoGUI extends JPanel{

    EmprestimoField emprestimoField;
    PaintMenu paintMenu;
    ComprovanteGUI comprovante;


    public AreaEmprestimoGUI(EmprestimoField emprestimoField) {

        this.emprestimoField = emprestimoField;

        setBounds(400, 160, 700, 570);
        setLayout(null);
        emprestimoField.setBounds(60, 20, 600, 120);
