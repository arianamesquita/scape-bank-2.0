...
/**
 * 
 * Classe que configura os itens da tela inicial trabalhando com os construtores
 * definidos na classe
 * LabelForm.
 * 
...
public class FrameComponents extends JPanel {
    ...
    public FrameComponents() {
        ...
        /**
         * Configurações totais do frame acontecem aqui, sendo definido a imagem de
         * fundo da tela,
         * o título na barra superior, o estilo de layout, o tamanho do frame com
         * largura e altura
         * (width e height), a posição relativa na tela e se o tamanho dela é ajustável
         * à tela.
         * 
         */
        ...
        /**
         * Criando um vetor que envia os parâmetros para o construtor da classe
         * LabelForm.
         * 
         */
        ...
        /**
         * Laço de repetição que retorna para o label as informações parametrizadas
         * acima no vetor do LabelForm.
         * 
         */
        ...
        for (int i = 0; i < 7; i++) {
            ...
            labels.setBounds(labelText[i].getX(), labelText[i].getY(), labelText[i].getWidth(),
                    labelText[i].getHeight());
            labels.setVisible(true);
            add(labels); // adiciona o label de imagem na tela inial, ou seja, no frame criado para ela.
        }

        /**
         * Iniciando a criação dos botões definindo um vetor para os botões e enviando
         * os parâmetros para
        ...
        /**
         * Criando um vetor de botões para as estilizações independentes de alguns
         * deles. Para as estilizações
         * que possuem parâmetros em comum utilizamos o laço de repetição for que vai
        ...
        for (int k = 0; k < 3; k++) {
            ...
            add(button[k]); // adiciona o label de botões na tela inicial, ou seja, no frame criado para
                            // ela.
        }
        ...
        /**
         * Inicializando e parametrizando o botão de check ao lado do campo de senha
         * para não mostrar
         * o que está sendo digitado (CheckBox). Ele não pode ser inicializado após as
         * imagens ou não
        ...
        /**
         * Começando a criação do campo de texto (textField) e do campo de senha
         * (passwordField) inicializando
         * as variáveis utilizadas para cada um deles.
         * 
         */

        /**
         * Chamando o construtor para organizar os parâmetros do textField (campo de
         * texto), desta forma
         * qualquer fica mais fácil fazer as modificações caso sejam necessárias.
         * 
         */
        LabelForm textField = new LabelForm("digite seu login:", ColorFontPaletas.font7(),
        ...
        /**
         * Chamando o construtor para organizar os parâmetros do passwordField (campo de
         * senha), desta forma
         * qualquer fica mais fácil fazer as modificações caso sejam necessárias.
         * 
         */
        ...
        add(JPF); // adiciona o passwordField ou campo de senha na tela inicial, ou seja, no frame
                  // criado para ela.

        /**
         * Aqui começamos a criar as imagens definidas na tela inicial criando dois
         * vetores, um para os labels
         * das imagens porque algumas possuem parâmetros específicos e um vetor para
         * definir as informações de
         * cada imagem que serão parametrizadas através do construtor da classe
         * LabelForm.
         * 
         */
        ...
        /**
         * Laço de repetição que define cada label do vetor com as informações
         * parametrizadas para cada imagem
        ...
        for (int j = 0; j < 6; j++) {
            ...
            labels2[j].setBounds(labelImage[j].getX(), labelImage[j].getY(), labelImage[j].getWidth(),
                    labelImage[j].getHeight());
            add(labels2[j]); // adiciona o label de imagem na tela inicial, ou seja, no frame criado para
                             // ela.
        }
        ...
        setVisible(true); // libera as informações adicionadas no frame da tela inicial para serem
                          // visíveis.
    }
